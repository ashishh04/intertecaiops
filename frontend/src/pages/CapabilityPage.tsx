...
const CapabilityPage = () => {
  ...
  return (
    <main className="pt-32 pb-20 px-6 md:px-16 min-h-screen flex flex-col items-center relative z-10">
      ...
      >
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full text-xs font-semibold mb-6 text-accentTheme">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-12">
            <div className="md:col-span-2">
                ...
                <div className="space-y-6 mb-12">
                    {[
                        ...
                        <div key={i} className="flex gap-4 items-center">
                            <div className="w-6 h-6 rounded-full bg-accentTheme/10 border border-accentTheme flex items-center justify-center shrink-0">
                                <CheckCircle2 size={14} className="text-accentTheme" />
                            </div>
                ...
                <div className="flex gap-4">
                    <button className="bg-accentTheme hover:bg-[#047857] text-white font-bold py-4 px-10 rounded-full transition-all shadow-lg hover:scale-105 active:scale-95">
                        Get Started
                    </button>
            ...
            <div className="space-y-6">
                <div className="p-6 rounded-2xl bg-[#0a0a0f] border border-white/5 shadow-2xl">
                    <h3 className="text-white font-bold mb-4 flex items-center gap-2">
                        <Zap size={18} className="text-accentTheme" /> Related Services
                    </h3>
                    <ul className="space-y-3">
                        {['Prompt-Driven Workflows', 'ITSM Automation', 'L1 Support', 'Data Automation'].map(item => (
                            <li key={item} className="text-sm text-white/50 hover:text-accentTheme cursor-pointer transition-colors flex items-center justify-between group">
                ...
                <div className="p-6 rounded-2xl bg-gradient-to-br from-accentTheme/20 to-transparent border border-accentTheme/20">
                    ...
                    <button className="text-accentTheme text-sm font-bold flex items-center gap-1 hover:underline">
