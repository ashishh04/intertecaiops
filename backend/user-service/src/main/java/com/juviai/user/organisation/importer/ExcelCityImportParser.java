...
@Slf4j
@Component
public class ExcelCityImportParser {

    public static final String SHEET_CITIES = "Cities";

    public List<CityImportRow> parse(InputStream inputStream, List<ImportRowError> errors) {
        List<CityImportRow> rows = new ArrayList<>();
        try (Workbook wb = new XSSFWorkbook(inputStream)) {
            Sheet sheet = wb.getSheet(SHEET_CITIES);
            if (sheet == null) {
    ...
    public static class CityImportRow {
