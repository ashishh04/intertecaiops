...
import com.juviai.user.organisation.web.mapper.DepartmentMapper;
...
public class DepartmentService {
    ...
    @Transactional(readOnly = true)
    public List<Department> listActiveDepartments(@NonNull UUID b2bUnitId) {
        if (!b2bUnitRepository.existsById(b2bUnitId)) {
            throw new IllegalArgumentException("B2B Unit not found with id: " + b2bUnitId);
        }
        return departmentRepository.findActiveListByB2bUnitId(b2bUnitId);
    }
