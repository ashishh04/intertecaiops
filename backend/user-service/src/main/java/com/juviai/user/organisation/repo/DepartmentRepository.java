...
public interface DepartmentRepository extends JpaRepository<Department, UUID> {
    ...
    @Query("SELECT d FROM Department d JOIN d.b2bUnits b2b WHERE d.active = true AND b2b.id = :b2bUnitId ORDER BY d.name")
    List<Department> findActiveListByB2bUnitId(@Param("b2bUnitId") UUID b2bUnitId);
